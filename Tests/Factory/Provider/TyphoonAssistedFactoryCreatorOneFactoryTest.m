...
- (Class)paymentFactoryClass
{
    ...
    {
        _paymentFactoryClass = [[[TyphoonAssistedFactoryCreatorOneFactory alloc] initWithProtocol:[self paymentFactoryProtocol] factoryBlock:^id (id<PaymentFactory> factory, NSDate *startDate, NSUInteger amount) {
