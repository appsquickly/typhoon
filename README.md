...
'The Typhoon Framework'. Or Michael? ___I don't work at SpringSource (I did once) and I'm not getting any financial benefit from this___. 
...
Wait, we're still not done yet. One last thing: There's been a criticism that the XML "un-readable", "pages and pages long", "all tangled up". "Bad!". 
