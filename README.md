...
Wait, we're still not done yet. One last thing: There's been a criticism that the XML is "un-readable", "pages and pages long", "heavy-weight", "all tangled up", "It made my son go blind!" ___Stop the press!___. . . 
